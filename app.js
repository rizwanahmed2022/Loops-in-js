...
var z = document.querySelector("#status");
z.innerHTML = "Loading...";
...
var Temperature = [30, 35, 32, 40]
var sumoftemp = 0
Temperature.forEach(function(i){
    sumoftemp += i
})
var averageTemp = document.querySelector('#averageTemp')
averageTemp.innerHTML += (sumoftemp/Temperature.length)
...
var ts = document.querySelector('#totalsum');
ts.innerHTML += p;
